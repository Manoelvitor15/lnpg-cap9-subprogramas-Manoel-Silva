...
def ler_produto(): print("") print(" PRODUTOS DISPONIVEIS ") print("") print("* ID * NOME * VALOR ") print("*****************************************")
...
def calcular_subtotal(preco, qtd): return preco * qtd

def calcular_desconto(total): if total > 500: return total * 0.10 elif total > 200: return total * 0.05 return 0.0

def calcular_total(total, desconto): return total - desconto

def imprimir_cupom(carrinho, total, desconto, total_final): print("" * 54) print(" CUPOM FISCAL ") print("" * 54)
